...
public class BoardEntity {
    ...
    private List<ProfsEntity> profs;
        ...
        public BoardEntity(Long id, String name, String image, String description, List<UserEntity> users, List<ScholarEntity> scholarships, List<ProfsEntity> profs) {
                this.id = id;
                this.name = name;
                this.image = image;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, boardEntity.id) && Objects.equals(name, boardEntity.name) && Objects.equals(image, boardEntity.image) && Objects.equals(description, boardEntity.description) && Objects.equals(users, boardEntity.users) && Objects.equals(scholarships, boardEntity.scholarships) && Objects.equals(profs, boardEntity.profs);
        }
